    ...
    <div className='episodepost-container'>
        <div className='episodepost-content'>
            <div className="video-box" onClick={toggleVideo1}>
                ...
                <iframe className={`iframe-video`}  width="100%" height="100%" src={videosrc} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
            </div>
        </div>
