  ...
  return (
    <div className='flex flex-col sm:flex-row justify-center items-center h-auto text-lg my-5'>
      ...
      <div className=" w-[100%] sm:w-[50%] text-center relative flex justify-center items-center" onClick={toggleVideo}>
        ...
        <Image className={`absolute w-[100%] h-[100%] object-cover z-10 ${videoPlayer ? 'hidden' : 'visible'}`} alt="VideoImage" src={promo} />
        <iframe className={`h-[300px] w-[95%] `}  width="100%" height="100%" src="https://www.youtube.com/embed/Pd3ikFsSNVM?si=zA9A4ugClU1hbWOv" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
      </div>
    </div>
  )
}
